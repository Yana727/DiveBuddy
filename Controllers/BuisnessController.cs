...
namespace DiveBuddy.Controllers
{
    public class BuisnessController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Address,PhoneNbr")] BuisnessModel buisnessModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Address,PhoneNbr")] BuisnessModel buisnessModel)
        {
